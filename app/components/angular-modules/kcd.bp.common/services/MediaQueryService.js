angular.module('kcd.bp.common.services').factory('MediaQueryService', function ($rootScope, $window) {
  'use strict';
...
}).run(function(MediaQueryService) {
  // initialize the MediaQueryService...
});