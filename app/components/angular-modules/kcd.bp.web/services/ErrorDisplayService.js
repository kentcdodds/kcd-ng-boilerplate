angular.module('kcd.bp.web.services').factory('ErrorDisplayService', function (_, $rootScope, $compile, MODULE_ROOT, $modal, AlertEventBroadcaster) {
  'use strict';
  var template = [
    ...
    if (errorsString.length > 124) {
      ...
      var message = $compile(angular.element(template))(_.extend(tempScope, {
        ...
        showModal: function(errors) {
          return $modal.open({
            templateUrl: MODULE_ROOT + 'services/modal-templates/errors-more-info.html',
