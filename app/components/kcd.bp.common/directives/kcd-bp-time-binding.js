angular.module('kcd.bp.common.directives').directive('kcdBpTimeBinding', function(moment, _, $parse) {
  'use strict';
  var comparators = {
    gt: function(a,b) {
      return a > b;
  ...
  return function kcdBpTimeBinding(scope, el, attrs) {
    var otherTimeGetter = $parse(attrs.otherTime);
    var otherTimeSetter = otherTimeGetter.assign;
    var myTimeGetter = $parse(attrs.kcdBpTimeBinding);
